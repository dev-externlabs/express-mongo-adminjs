...
const login = catchAsync(async (req: Request<object, object, {email:string, password:string}>, res: Response) => {
...
const logout = catchAsync(async (req: Request<object, object, {refreshToken:string}>, res: Response) => {
...
const verifyEmail = catchAsync(async (req: Request<object, object, {password:string}, {token:string}>, res: Response) => {
